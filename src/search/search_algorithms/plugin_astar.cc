...
public:
    ...
    create_component(const plugins::Options &opts) const override {
        ...
        auto transform = opts.get<shared_ptr<AbstractTask>>("transform");
        ...
        return make_shared<eager_search::EagerSearch>(
            ...
            options_copy.get<shared_ptr<PruningMethod>>("pruning", nullptr),
            options_copy.get<shared_ptr<Evaluator>>("lazy_evaluator", nullptr),
